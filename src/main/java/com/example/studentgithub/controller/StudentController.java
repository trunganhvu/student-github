package com.example.studentgithub.controller;

import com.example.studentgithub.entity.Student;
...
public class StudentController {
    ...
    public List<Student> getStudents() {
        ...
        students.add(new Student(4, "Zoey", "10C", 15, "789 Oak St", 80, 85, 70, 90,78));
